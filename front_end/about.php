...
<body>
  <div class="row justify-content-center mt-5">
    <h5 class="col-7 text-left fw-bold">
      Sistema desenvolvido em 6 dias por Samuel Filipe Faria
      durante o 6° semestre do Bacharelado em Sistemas de Informação
      na disciplina de Gerência de Projetos
      ministrada pelo Professor Luiz Cláudio
      voltado para auxiliar nas atividades dos estudantes na feira de negócios do
