...
<body>
  <div class="row my-5 text-center justify-content-center">
    <div class="col-7">
      <h5 class="my-2">Tem certeza que deseja sair? Terá que realizar login novamente se quiser acessar o time.</h5>
      <br> <br>
      <form method="POST" action="../back_end/logout_team.php">
        <button type="submit" class="btn" style="background-color: #38ff98; color: #000;"><i class="ri-logout-box-line"></i> Sim, quero sair</button>
      </form>
    </div>
  </div>
</body>
